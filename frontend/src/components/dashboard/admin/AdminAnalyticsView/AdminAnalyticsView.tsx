...
export default function AdminAnalyticsView() {
  ...
  const charts = [
    ...
    {
      id: "roadmaps",
      title: "Roadmaps Created Over Time",
      data: timeSeries?.roadmaps || [],
      stroke: secondary,
    },
    {
      id: "projects",
      title: "Projects Submitted Over Time",
      data: timeSeries?.projects || [],
      stroke: dark ? "#7de3c0" : "#10b981",
    },
    {
      id: "assessments",
      title: "Assessments Taken Over Time",
      data: timeSeries?.assessments || [],
      stroke: dark ? "#ffc27a" : "#f59e0b",
    },
  ];
