    ...
    <Card className="border-dashed border-2 border-border/60 bg-transparent shadow-none">
      <CardContent className="flex flex-col items-center justify-center p-12 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-md">
          Your portfolio strength is directly tied to the projects you build.
          Add your first project to start building your developer proof graph.
        </p>
        <DashboardButton
  ...
  return (
    <div className="flex flex-col gap-8 pb-12 animate-in fade-in duration-500">
      <PageHeader
        ...
        description="Manage and analyze your project portfolio evidence."
      />
        ...
        <CardContent className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex-1 space-y-2 text-center md:text-left">
            ...
            <p className="text-muted-foreground max-w-xl">
              Based on the technical depth, explanation quality, and verifiable
              evidence of your projects.
            </p>
          </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${project.metrics.technicalDepth}%` }}
                      />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-3">
                    {project.metrics.evidence === "verified" ? (
                      ...
                      <span
                        ...
                        title="The provided URLs could not be reached or verified."
                      >
