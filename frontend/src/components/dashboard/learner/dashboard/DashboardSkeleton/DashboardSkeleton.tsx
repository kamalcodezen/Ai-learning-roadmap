export default function DashboardSkeleton() {
  return (
    <div className="flex h-[94vh] w-full flex-col overflow-y-hidden dashboard-card-gap">
      ...
      <div className="w-full h-[18%] shrink-0 bg-primary/20 animate-pulse rounded-lg border border-primary/20" />
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-3 dashboard-card-gap">
        ...
        <div className="col-auto lg:col-span-1">
          <div className="skeleton-card h-full">
            <div className="h-[25%] bg-primary/20 animate-pulse rounded-t-lg">
              <div />
            </div>
            <div className="h-[65%] bg-primary/15 animate-pulse m-4 rounded-lg">
              <div />
            </div>
          </div>
        </div>
      ...
      <div className="grid h-[38%] shrink-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 dashboard-card-gap">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="skeleton-card h-full">
            <div className="h-[20%] bg-primary/20 animate-pulse rounded-t-lg">
              <div />
            </div>
            <div className="h-[70%] bg-primary/15 animate-pulse m-4 rounded-lg">
              <div />
            </div>
          </div>
        ))}
