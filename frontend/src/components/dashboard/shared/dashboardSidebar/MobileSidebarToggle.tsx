...
export default function MobileSidebarToggle({ onOpen }: MobileSidebarToggleProps) {
  ...
  return (
    <header
      role="banner"
      className="fixed inset-x-0 top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/80 px-4 backdrop-blur-xl lg:left-64 lg:px-6 transition-all duration-200"
    >
      ...
      <button
        ...
        className="flex size-10 items-center justify-center rounded-xl border border-border text-foreground transition-colors hover:bg-foreground/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 lg:hidden"
      >
