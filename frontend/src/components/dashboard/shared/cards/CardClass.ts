...
export const plainCardClass =
  "relative overflow-hidden rounded-xl border border-[#E6E9EE]  backdrop-blur-md transition-all duration-300 proof-card dark:border-[rgba(159,84,247,0.15)] p-6";
...
export const glowCardClass =
  "group relative overflow-hidden rounded-xl transition-all duration-300 border-2 border-background shadow-none kpi-card-gradient";
