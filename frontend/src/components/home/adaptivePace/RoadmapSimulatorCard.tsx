  ...
  return (
    <div className="dashboard-card w-full rounded-lg p-4 sm:p-8 lg:p-10 transition-all duration-300">
      ...
      <div className="flex flex-col md:flex-col lg:flex-row lg:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-border/60">
        <div className="flex items-center gap-3 sm:gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-xs sm:text-base font-medium text-muted-foreground">Live ETA Calculator</span>
            </div>
        ...
        {/* Live Pace Badge */}
        <div className={`self-start lg:self-center px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full border text-xs sm:text-base font-semibold ${simulation.paceColor}`}>
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-5 sm:gap-6">
          <div>
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-2xl sm:text-3xl font-black text-[var(--color-primary)] tabular-nums">
                  {weeklyHours}
                </span>
                <span className="text-xs sm:text-sm font-medium text-muted-foreground">hours / week</span>
              </div>
            </div>
            ...
            <div className="relative py-1.5 sm:py-2">
              ...
              />
              <div className="flex justify-between text-xs sm:text-base font-medium text-muted-foreground mt-2 sm:mt-2.5">
          ...
          {/* Quick Presets */}
          <div>
            <span className="text-xs sm:text-base font-medium text-muted-foreground mb-2 sm:mb-2.5 block">
          ...
          <div className="rounded-xl border border-[var(--color-primary)]/20 bg-gradient-to-r from-[var(--color-primary)]/10 via-[var(--color-secondary)]/5 to-transparent p-3.5 sm:p-4 text-xs sm:text-base text-muted-foreground">
        ...
        <div className="lg:col-span-5 rounded-xl border border-border/80 bg-gradient-to-b from-[#faf5ff] to-[#f3e8ff]/50 dark:from-[#150727] dark:to-[#0a0015] p-4 sm:p-6 flex flex-col justify-between shadow-inner">
          <div>
            <span className="text-xs sm:text-base font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
            ...
            <div className="mt-3 sm:mt-4 flex items-baseline gap-2">
              ...
              <span className="text-base sm:text-lg font-semibold text-muted-foreground">Weeks</span>
              <span className="text-xs sm:text-base font-medium text-muted-foreground">({simulation.months} Months)</span>
            </div>

            <div className="mt-4 sm:mt-5 space-y-2.5 sm:space-y-3">
              <div className="flex items-center justify-between text-xs sm:text-base py-1.5 sm:py-2 border-b border-border/40">
              ...
              <div className="flex items-center justify-between text-xs sm:text-base py-1.5 sm:py-2">
                <span className="text-muted-foreground flex items-center gap-1.5 sm:gap-2">
