  ...
  return (
    <div className="relative w-full overflow-hidden z-20">
      ...
      <div className="relative w-full overflow-hidden leading-none pointer-events-none -mb-[1px]">
        ...
        <div className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 h-8 sm:h-10 w-3/4 max-w-4xl rounded-full bg-purple-500/10 blur-xl" />

        <svg
          viewBox="0 0 1440 70"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-full h-6 sm:h-8 md:h-10 lg:h-12 block object-fill"
      ...
      <section
        ...
        className="relative w-full overflow-hidden bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] py-2 sm:py-2.5 md:py-3 shadow-[0_10px_36px_rgba(159,84,247,0.35)] transition-colors dark:shadow-[0_10px_36px_rgba(185,120,255,0.3)]"
      >
