    ...
    <section className="relative w-full overflow-hidden py-section">
      ...
      <div className="relative w-full">
        ...
        <div className="global-pos flex items-center justify-between px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="hidden items-center gap-2 rounded-full border border-[var(--color-primary)]/30 bg-[#131824] px-3.5 py-1.5 shadow-[0_0_15px_rgba(159,84,247,0.15)] sm:flex">
