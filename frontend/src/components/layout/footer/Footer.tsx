...
export default function Footer() {
	return (
		<footer className="relative w-full flex flex-col items-center justify-center border-t border-white/10 bg-[#060911] bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] px-6 py-12 lg:py-16 mt-auto overflow-hidden">
			...
			<div className="w-[90%] md:w-full md:max-w-[80%] mx-auto z-10 flex flex-col items-center">
				<AnimatedContainer className="flex flex-col items-center justify-center space-y-10 w-full pb-12">
					{/* Logo and Tagline */}
					<div className="flex flex-col items-center">
						<Link href="/" className="flex items-center mt-20 space-x-3 md:space-x-4">
							<Image src="/logo-p.png" alt="AI Pather" width={70} height={70} className="w-10 h-10 md:w-[70px] md:h-[70px] object-contain" />
				...
				<AnimatedContainer delay={0.2} className="w-full pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
