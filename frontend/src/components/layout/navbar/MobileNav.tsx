  ...
  return (
    <div className="w-full flex justify-center relative">
      <motion.div 
        ...
        className="bg-white/80 backdrop-blur-[5px] border border-[#cccccc] py-1 px-1 w-90 max-w-sm mx-auto overflow-hidden flex flex-col z-50"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <button 
            ...
            className={`flex flex-col shrink-0 items-center justify-center w-10 h-10 bg-[#333333] rounded-full hover:bg-[#1a1a1a] transition-all focus:outline-none gap-1 mr-1 relative ${isOpen ? 'mt-3' : ''}`}
            aria-label="Toggle menu"
          >
            <div className={`w-3 h-0.5 bg-white rounded-full transition-transform duration-300 ${isOpen ? 'translate-y-0 rotate-45 absolute' : ''}`} />
            <div className={`w-3 h-0.5 bg-white rounded-full transition-transform duration-300 ${isOpen ? 'translate-y-0 -rotate-45 absolute' : ''}`} />
          </button>
        </div>
            ...
            >
              <div className="flex flex-col items-center gap-6 pt-6 pb-2 px-4">
                <div className="flex flex-col gap-6 w-full items-center mt-2">
                  <a href="#" className="text-[17px] text-[#333333] hover:text-black transition-colors">About Us</a>
                  <a href="#" className="text-[17px] text-[#333333] hover:text-black transition-colors">How it works</a>
                </div>
