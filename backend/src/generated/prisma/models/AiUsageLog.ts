...
export type AiUsageLogWhereInput = {
  ...
  status?: Prisma.StringFilter<"AiUsageLog"> | string
...
export type AiUsageLogScalarWhereWithAggregatesInput = {
  ...
  status?: Prisma.StringWithAggregatesFilter<"AiUsageLog"> | string
...
export type AiUsageLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "provider" | "model" | "feature" | "status" | "durationMs" | "tokensUsed" | "errorMessage" | "createdAt", ExtArgs["result"]["aiUsageLog"]>
...
export interface AiUsageLogFieldRefs {
  ...
  readonly status: Prisma.FieldRef<"AiUsageLog", 'String'>
