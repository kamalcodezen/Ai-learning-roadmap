 ...
 */
router.post("/generate", requireAuth, requirePlan(["PRO"]), async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = req.userId as string;
 ...
 */
router.post("/scan", requireAuth, requirePlan(["PRO"]), async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = req.userId as string;
 ...
 */
router.post("/upload-scan", requireAuth, requirePlan(["PRO"]), async (req: Request, res: Response, next: NextFunction) => {
  try {
